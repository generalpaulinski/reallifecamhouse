    ...
    return (
        <section>
            <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
                <h3 className="h4 mb-2 text-white">Welcome to Our Unique Live
                ...
                <h3 className="h4 mb-2 text-white">Hidden Cams, Spy Cams – See
                    the Unseen!</h3>
                ...
                <h3 className="h4 mb-2 text-white">Real Cams, Real People, Real
                    Life</h3>
                ...
                <h3 className="h4 mb-2 text-white">Discover the Thrill of True
                    Life with Premium
                    Membership</h3>
                ...
                <h3 className="h4 mb-2 text-white">Ready for the Full Voyeur
                    House Experience?</h3>

                <p className="mb-2 text-white">By subscribing to our Premium
                ...
                <h4 className="h5 mb-2 text-white">Register Now – Your Ultimate
